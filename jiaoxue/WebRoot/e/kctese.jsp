...
<body>
	...
	<div class="wrap round-block" >
		  ...
		  <div style="width:280px;float:left;min-height:300px;background:#008c8c;">
		      <div class="simple-category" >
		          ...
		          <div class="content">
		              <ul>
		                 <li>
		                    <a href="${pageContext.request.contextPath}/e/kctese.jsp?id=10">课程介绍</a>
		                 </li>
		                
		                   <li>
		                       <a href="${pageContext.request.contextPath}/e/kctese.jsp?id=11">同类课程比较</a>
		                   </li>
