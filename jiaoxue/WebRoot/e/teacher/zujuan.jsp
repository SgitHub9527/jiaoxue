...
<%
    ...
    if( sjid!=null)
    {
       ...
       temobjshijuan=(Shijuan)DALBase.load("shijuan"," where id="+ sjid);
	 ...
	 <jsp:include page="/e/head.jsp"></jsp:include>
		  <div class="wrap round-block">
			<div class="line-title">
				  当前位置：<a href="${pageContext.request.contextPath}/e/index.jsp">首页</a>>> 在线组卷
			</div>
	  ...
	  <div  class="main-content">	
	          <div class="search-title">
	                <h2>
	                      ${requestScope.shijuan.title}  满分:(<%=temobjshijuan.getZongfen()%>分)  当前试卷总分:  <span  id="spZongfen">  </span>   
	                </h2>
              ...
              <form  id="form1" name="form1" method="post" action="${pageContext.request.contextPath}/admin/shijuanmanager.do">
				...
				<input type="hidden" name="forwardurl" value="/e/teacher/zujuan.jsp?sjid=<%=sjid%>"  />
				...
				<table border="0" cellspacing="1" class="grid" cellpadding="0"
					...
					<tr>
						<td  height="30">选择题目
						     ...
						     <a class="orange-href" href="${pageContext.request.contextPath}/admin/ceshitimanager.do?actiontype=get&forwardurl=/e/teacher/ceshitichoose.jsp?sjid=<%=temobjshijuan.getId() %>&seedid=103">添加单选题</a>
					   ...
					   <%
                          ...
                          List<Shijuanitem> danxuanlist=(List<Shijuanitem>)DALBase.getEntity("shijuanitem", "where tixing='单选题' and shijuanid="+sjid);
                          for(Iterator<Shijuanitem> it=danxuanlist.iterator();it.hasNext();i++)
                           {
                              
                               Shijuanitem sji=it.next();
                               Ceshiti temdanxuan=(Ceshiti) DALBase.load("ceshiti","where id="+sji.getTihao());
                               if(temdanxuan!=null){
                        %>
                          ...
                          <td>
                            ...
                            <%=i %> <%=temdanxuan.getTitle() %> <a href="${pageContext.request.contextPath}/admin/shijuanmanager.do?actiontype=removeShiti&sjid=<%=sjid %>&tihao=<%=sji.getId() %>&forwardurl=/e/teacher/zujuan.jsp?sjid=<%=sjid%>">从试卷中删除</a>
