			...
			$(function() {
			    $("#btnDelete").click(function(){
			        ...
			        $(".check:checked").each(function(index,domEle){
			             var id=$(domEle).val();
			             $.dialog.confirm("你确定要注销试题集信息?", function(){
				             window.location.href=encodeURI('${pageContext.request.contextPath}/admin/ceshitimanager.do?&forwardurl=/e/teacher/ceshitimanager.jsp&actiontype=delete&id='+id);
				          });
			        });
			    });
	...
	<div class="wrap round-block">
		...
		<div class="main">
			...
			<div class="main-content">
						...
						<table cellspacing="0" width="100%">
							<tbody>
								<tr>
									...
									<input
										type="hidden" name="forwardurl" value="/e/teacher/ceshitimanager.jsp" />
				...
				<table id="module" width="100%" border="0" cellspacing="0"
					...
					<tbody>
						...
						<%	
							...
							%>
						<tr>
							<td>&nbsp<input id="chk<%=temceshiti.getId()%>"
								class="check" name="chk<%=temceshiti.getId()%>" type="checkbox"
								value='<%=temceshiti.getId()%>'></td>
							...
							<td><a class="orange-href"
								href="${pageContext.request.contextPath}/admin/ceshitimanager.do?actiontype=load&id=<%=temceshiti.getId()%>&seedid=206&forwardurl=/e/teacher/ceshitiadd.jsp">修改</a>
				...
				<div class="clear"></div>
				<daowen:pager id="pager1" attcheform="shitiForm" />
			</div>
		</div>
	</div>
