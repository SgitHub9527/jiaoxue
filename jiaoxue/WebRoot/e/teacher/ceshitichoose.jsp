			   ...
			   <div class="search-title">
                ...
                <div class="description">
					...
					<!-- 搜索控件开始 -->
					  ...
					  <form id="shitiForm"  action="${pageContext.request.contextPath}/admin/ceshitimanager.do" method="post" >
					        ...
					        <tbody>
					          <tr>
					             <td>
					                  ...
					                  <input type="hidden"   name="forwardurl" value="/e/teacher/ceshitichoose.jsp"/>
					                 <div class="ui-button">
				...
				<table id="module" width="100%" border="0" cellspacing="0"
					...
					<tbody>
						...
						<tr>
							...
							<%
							    ...
							    if(sjid!=null){
							    //如果试题已经试卷中
							    if(DALBase.isExist("shijuanitem", MessageFormat.format("where shijuanid={0} and tihao={1}",sjid,temceshiti.getId())))
							    {
							%>
							     已加入试卷
							  <%}else{ %>
					...
					<form
						...
						<input type="hidden" name="actiontype" value="addShiti" /> <input
							...
							value="/e/teacher/zujuan.jsp?sjid=<%=sjid%>" /> <input
