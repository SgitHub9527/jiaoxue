			    ...
			    $("#btnDelete").click(function(){
			        ...
			        $(".check:checked").each(function(index,domEle){
			             ...
			             top.$.dialog.confirm("你确定要注销留言信息?", function(){
				             window.location.href=encodeURI('${pageContext.request.contextPath}/admin/leavewordmanager.do?forwardurl=/e/teacher/leavewordmanager.jsp&actiontype=delete&id='+id);
				         });
			        });
			    });
