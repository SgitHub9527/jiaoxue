			    ...
			    $("#btnDelete").click(function(){
			        ...
			        $(".check:checked").each(function(index,domEle){
			             ...
			             $.dialog.confirm("你确定要注销收藏夹信息?", function(){
				             window.location.href=encodeURI('${pageContext.request.contextPath}/admin/shoucangmanager.do?forwardurl=/e/huiyuan/shoucangmanager.jsp&scren=${huiyuan.accountname}&actiontype=delete&id='+id);
				          });
			        });
			    });
