...
<body>
	...
	<div class="wrap round-block">
		<div class="cover-title">
			当前位置：<a href="index.jsp">首页</a> &gt;&gt; 登录密码修改
		</div>
		   ...
		   <div class="main">
		       ...
		       <div class="main-content">
					 ...
					 <form name="formModifypw" action="${pageContext.request.contextPath}/admin/huiyuanmanager.do" id="formModifypw" method="post">
					   ...
					   <input type="hidden" name="errorurl" value="/e/huiyuan/modifypw.jsp"/>
						<table border="0" cellspacing="1" class="grid" cellpadding="0"
							width="100%">
							<tr>
								<td align="right">原始密码 :</td>
								<td align="left">
								    <input name="password" type="password" validate="{required:true,messages:{required:'请输入原始支付密码'}}"
									 class="input-txt" /></td>
								<td align="left">
							...
							<tr>
								...
								<td align="left">
								    <input name="repassword1" type="password" validate="{required:true,messages:{required:'请输入新的支付密码'}}"
							...
							<tr>
								...
								<td align="left"><input name="repassword2" validate="{required:true,equalTo:'#repassword1',messages:{required:'请再次输入支付密码',equalTo:'两次支付密码不一致'}}" type="password"
