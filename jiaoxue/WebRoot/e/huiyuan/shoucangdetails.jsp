...
<%
    ...
    {
      command="update";
      Shoucang temobjshoucang=(Shoucang)DALBase.load("shoucang"," where id="+ id);
			...
			<div class="main-content">	
			       <!-----开始---->
			               <table cellpadding="0" cellspacing="1" class="grid" width="100%" >
											   ...
											   <td>
												   ${requestScope.shoucang.bookid}
												</td>
											   </tr>
											   <tr>
											   <td width="10%" align="right" >书名称:</td>
											   <td>
												   ${requestScope.shoucang.bookname}
												</td>
											   </tr>
											   <tr>
											   <td width="10%" align="right" >图片:</td>
											   <td>
												   ${requestScope.shoucang.tupian}
												</td>
											   </tr>
											   <tr>
											   <td width="10%" align="right" >收藏人:</td>
											   <td>
												   ${requestScope.shoucang.scren}
												</td>
											   </tr>
											   <tr>
											   <td align="right">收藏时间:</td>
											   <td>
												      <fmt:formatDate  value="${requestScope.shoucang.sctime}" pattern="yyyy-MM-dd" />
												</td>
											   </tr>
				        </table>
			        <!-----结束---->
