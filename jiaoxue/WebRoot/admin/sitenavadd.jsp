		...
		<table class="grid" cellspacing="1" width="100%">
			...
			<tr>
				...
				<td><input name="title" placeholder="标题"
					...
					value="${requestScope.sitenav.title}" class="input-txt" type="text"
					id="txtTitle" /></td>
			</tr>
			<tr>
				<td align="right">连接:</td>
				<td><input name="href" placeholder="连接"
					validate="{required:true,messages:{required:'请输入连接'}}"
					value="${requestScope.sitenav.href}" class="input-txt" type="text"
					id="txtHref" /></td>
			</tr>
			<tr>
				<td align="right">序列号:</td>
				<td><input name="sindex" placeholder="序列号"
					validate="{required:true,messages:{required:'请输入序列号'}}"
					value="${requestScope.sitenav.sindex}" class="input-txt"
					type="text" id="txtSindex" /></td>
			</tr>
			<tr>
				<td colspan="4">
					<div class="ui-button">
