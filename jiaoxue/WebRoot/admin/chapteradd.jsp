...
<body>
	...
	<form name="chapterform" method="post"
		...
		<table class="grid" cellspacing="1" width="100%">
			...
			<input name="section" placeholder="是节"
					validate="{required:true,messages:{required:'请输入是节'}}"
					value="0"  type="hidden"  />
		    <input name="parentid" placeholder="父节点"
					validate="{required:true,messages:{required:'请输入父节点'}}"
					value="0" type="hidden" />
			<input type="hidden" name="errorurl" value="/admin/chapteradd.jsp" />
			<input type="hidden" name="forwardurl"
				value="/admin/bookinfo.jsp" />
			<tr>
