						...
						<tr data-tt-id='<%=temlanmu.getId() %>' parentid="<%=temlanmu.getParentid()%>">
							<td style="text-align:left;">
							  ...
							  %>
							       ...
							       <a lanmuid='<%=temlanmu.getId() %>' class="btn-lanmu-delete orange-href"  href="${pageContext.request.contextPath}/admin/sitenavmanager.do?actiontype=saveByLanmuguide&xtype=1&lanmuid=<%=temlanmu.getId() %>&forwardurl=/admin/sitenavmanager.do?actiontype=get">
