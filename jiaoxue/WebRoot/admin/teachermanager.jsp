	  ...
	  <body >
			   ...
			   <div class="search-title">
                ...
                <div class="description">
                    <a href="${pageContext.request.contextPath}/admin/teachermanager.do?actiontype=load&seedid=102">新建教师</a>
                </div>
              </div>
					<!-- 搜索控件开始 -->
					  <div class="search-options">
					  <form id="searchForm"  action="${pageContext.request.contextPath}/admin/teachermanager.do" method="post" >
					<table class="grid" cellspacing="1" width="100%">
						<tbody>
							<tr>
								<td>教师号 <input name="tno" value="${tno}" class="input-txt"
									type="text" id="tno" /> 教师名 <input name="name"
									value="${name}" class="input-txt" type="text" id="name" /> <input
					...
					<c:forEach var="temteacher" items="${listteacher}">
						<tr>
							...
							<td>
							    ...
							    <a class="orange-href" href="teacherdetails.jsp?id=${temteacher.id}&seedid=304">查看</a>
							</td>
						</tr>
					</c:forEach>
				</tbody>
