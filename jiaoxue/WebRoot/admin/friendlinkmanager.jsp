	  ...
	  <body >
			   ...
			   <div class="search-title">
                ...
                <div class="description">
                    <a href="${pageContext.request.contextPath}/admin/friendlinkmanager.do?actiontype=load&seedid=208">新建友情链接</a>
                </div>
              </div>
					<!-- 搜索控件开始 -->
					  <div class="search-options">
					  <form id="searchForm"  action="${pageContext.request.contextPath}/admin/friendlinkmanager.do" method="post" >
					...
					<td >${temfriendlink.title}</td>
								...
								<td >
								     <a class="edit" href="${pageContext.request.contextPath}/admin/friendlinkmanager.do?actiontype=load&id=${temfriendlink.id}&seedid=208">修改</a>
