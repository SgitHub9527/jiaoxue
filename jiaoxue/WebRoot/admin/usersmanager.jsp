			    ...
			    $("#btnDelete").click(function(){
			        ...
			        $(".check:checked").each(function(index,domEle){
			             ...
			             top.$.dialog.confirm("你确定要注销后台用户信息?", function(){
				             window.location.href=encodeURI('${pageContext.request.contextPath}/admin/usersmanager.do?forwardurl=/admin/usersmanager.jsp&actiontype=delete&id='+id);
				         });
			        });
			    });
	 ...
	 <body >
		<div class="search-title">
			...
			<div class="description">
				<a  href="${pageContext.request.contextPath}/admin/usersmanager.do?actiontype=load">新建后台用户</a>
			</div>
		</div>
					<!-- 搜索控件开始 -->
	...
	<table id="users" width="100%" border="0" cellspacing="0"
		...
		<tbody>
			...
			<tr>
				...
				<td><%=sdf.format(temusers.getCreatetime())%></td>
				...
				<td>
				   <a class="btn btn-success"
					href="${pageContext.request.contextPath}/admin/usersdetails.jsp?id=<%=temusers.getId()%>"><i
