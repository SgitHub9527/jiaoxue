...
<html>
			    ...
			    $("#btnDelete").click(function(){
			        ...
			        $(".check:checked").each(function(index,domEle){
			             ...
			             $.dialog.confirm("你确定要注销测试题信息?", function(){
				             window.location.href=encodeURI('${pageContext.request.contextPath}/admin/ceshitimanager2.do?actiontype=delete&id='+id);
				          });
			        });
			    });
	...
	<div class="search-title">
		...
		<div class="description">
			<a
				href="${pageContext.request.contextPath}/admin/ceshitimanager2.do?actiontype=load&seedid=102">新建测试题</a>
		</div>
	</div>
	<!-- 搜索控件开始 -->
		...
		<tbody>
			...
			<tr>
				...
				<td>
				  ...
				  <a class="orange-href"
					href="${pageContext.request.contextPath}/admin/ceshitimanager2.do?actiontype=load&id=<%=temceshiti.getId()%>">修改</a>
