			...
			$(function() {
			    $("#btnDelete").click(function(){
			        ...
			        $(".check:checked").each(function(index,domEle){
			             var id=$(domEle).val();
			             top.$.dialog.confirm("你确定要注销首页栏目信息?", function(){
				             window.location.href=encodeURI('${pageContext.request.contextPath}/admin/indexcolumnsmanager.do?forwardurl=/admin/indexcolumnsmanager.jsp&actiontype=delete&id='+id);
				         });
			        });
			    });
		...
		<tbody>
			...
			<tr>
				<td>&nbsp<input id="chk<%=temindexcolumns.getId()%>"
					class="check" name="chk<%=temindexcolumns.getId()%>"
