...
<body>
             ...
             <div class="search-title">
	                <h2>
	                       友情链接管理->  <a href="${pageContext.request.contextPath}/admin/friendlinkmanager.do?actiontype=load&seedid=208">新建友情链接</a>
	                </h2>
                <div class="description">
                </div>
              </div>
				    <form name="friendlinkform" method="post" action="${pageContext.request.contextPath}/admin/friendlinkmanager.do"  id="friendlinkForm">
