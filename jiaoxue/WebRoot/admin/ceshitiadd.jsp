	...
	<form name="ceshitiform1" method="post"
		...
		<table class="grid" cellspacing="1" width="100%">
			...
			<tr>
				...
				<td><input name="choicee"
					validate="{required:true,messages:{required:'请输入选项E'}}"
					value="${requestScope.ceshiti.choicee}" class="input-txt"
					type="text" id="txtChoiced" /></td>
			</tr>
			<tr>
				<td align="right">答案:</td>
				<td><input name="daan"
					validate="{required:true,messages:{required:'请输入答案'}}" value="A"
					checked="checked" type="checkbox" />A <input name="daan"
					validate="{required:true,messages:{required:'请输入答案'}}" value="B"
					type="checkbox" />B <input name="daan"
					validate="{required:true,messages:{required:'请输入答案'}}" value="C"
					type="checkbox" />C <input name="daan"
					validate="{required:true,messages:{required:'请输入答案'}}" value="D"		
					type="checkbox" />D<input name="daan"
					validate="{required:true,messages:{required:'请输入答案'}}" value="E"
					type="checkbox" />E</td>
